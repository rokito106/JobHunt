                ...
                <div className='flex justify-between items-center'>
                    <div className='flex items-center gap-4'>
                        <Avatar className="h-24 w-24">
                            <AvatarImage src="https://www.shutterstock.com/shutterstock/photos/2447689579/display_1500/stock-photo-unique-blue-colour-gradient-logo-design-amazing-logo-for-company-or-brand-abstract-neon-glowing-2447689579.jpg" alt="profile" />
                        </Avatar>
                        <div>
